...
@RestController
@RequestMapping("/api/j-hipster-microservice-kafka")
public class JHipsterMicroserviceKafkaResource {

    private static final String PRODUCER_BINDING_NAME = "binding-out-0";

    private static final Logger LOG = LoggerFactory.getLogger(JHipsterMicroserviceKafkaResource.class);
    private final KafkaConsumer kafkaConsumer;
    private final StreamBridge streamBridge;

    public JHipsterMicroserviceKafkaResource(StreamBridge streamBridge, KafkaConsumer kafkaConsumer) {
