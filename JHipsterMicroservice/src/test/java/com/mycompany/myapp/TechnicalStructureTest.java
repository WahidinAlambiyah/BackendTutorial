...
@AnalyzeClasses(packagesOf = JHipsterMicroserviceApp.class, importOptions = DoNotIncludeTests.class)
class TechnicalStructureTest {
    ...
    static final ArchRule respectsTechnicalArchitectureLayers = layeredArchitecture()
        ...
        .ignoreDependency(belongToAnyOf(JHipsterMicroserviceApp.class), alwaysTrue())
