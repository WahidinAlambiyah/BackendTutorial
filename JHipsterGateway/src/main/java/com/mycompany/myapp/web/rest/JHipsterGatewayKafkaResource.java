...
@RestController
@RequestMapping("/api/j-hipster-gateway-kafka")
public class JHipsterGatewayKafkaResource {

    private static final String PRODUCER_BINDING_NAME = "binding-out-0";

    private static final Logger LOG = LoggerFactory.getLogger(JHipsterGatewayKafkaResource.class);
    private final KafkaConsumer kafkaConsumer;
    private final StreamBridge streamBridge;

    public JHipsterGatewayKafkaResource(StreamBridge streamBridge, KafkaConsumer kafkaConsumer) {
