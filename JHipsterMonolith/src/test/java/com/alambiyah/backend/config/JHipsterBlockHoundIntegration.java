package com.alambiyah.backend.config;
...
public class JHipsterBlockHoundIntegration implements BlockHoundIntegration {
    ...
    public void applyTo(BlockHound.Builder builder) {
        ...
        builder.allowBlockingCallsInside("com.alambiyah.backend.service.MailService", "sendEmailFromTemplate");
        builder.allowBlockingCallsInside("com.alambiyah.backend.security.DomainUserDetailsService", "createSpringSecurityUser");
