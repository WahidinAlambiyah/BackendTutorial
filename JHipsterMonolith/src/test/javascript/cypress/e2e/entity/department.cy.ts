...
describe('Department e2e test', () => {
  ...
  const departmentSample = { departmentName: 'and where besides' };
  ...
  describe('new Department page', () => {
    ...
    it('should create an instance of Department', () => {
      cy.get(`[data-cy="departmentName"]`).type('action bah');
      cy.get(`[data-cy="departmentName"]`).should('have.value', 'action bah');
