...
describe('Event e2e test', () => {
  ...
  const eventSample = { title: 'pro toward', date: '2024-09-14T04:31:22.168Z' };
  ...
  describe('new Event page', () => {
    ...
    it('should create an instance of Event', () => {
      cy.get(`[data-cy="title"]`).type('big-hearted within');
      cy.get(`[data-cy="title"]`).should('have.value', 'big-hearted within');

      cy.get(`[data-cy="description"]`).type('../fake-data/blob/hipster.txt');
      cy.get(`[data-cy="description"]`).invoke('val').should('match', new RegExp('../fake-data/blob/hipster.txt'));

      cy.get(`[data-cy="date"]`).type('2024-09-14T01:12');
      cy.get(`[data-cy="date"]`).blur();
      cy.get(`[data-cy="date"]`).should('have.value', '2024-09-14T01:12');

      cy.get(`[data-cy="location"]`).type('both outflank');
      cy.get(`[data-cy="location"]`).should('have.value', 'both outflank');

      cy.get(`[data-cy="capacity"]`).type('30026');
      cy.get(`[data-cy="capacity"]`).should('have.value', '30026');

      cy.get(`[data-cy="price"]`).type('30580.62');
      cy.get(`[data-cy="price"]`).should('have.value', '30580.62');
