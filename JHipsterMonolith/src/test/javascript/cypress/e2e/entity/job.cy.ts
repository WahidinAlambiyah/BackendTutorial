...
describe('Job e2e test', () => {
  ...
  const jobSample = { jobTitle: 'Principal Functionality Coordinator' };
  ...
  describe('new Job page', () => {
    ...
    it('should create an instance of Job', () => {
      cy.get(`[data-cy="jobTitle"]`).type('Corporate Communications Planner');
      cy.get(`[data-cy="jobTitle"]`).should('have.value', 'Corporate Communications Planner');

      cy.get(`[data-cy="minSalary"]`).type('3883');
      cy.get(`[data-cy="minSalary"]`).should('have.value', '3883');

      cy.get(`[data-cy="maxSalary"]`).type('7986');
      cy.get(`[data-cy="maxSalary"]`).should('have.value', '7986');
