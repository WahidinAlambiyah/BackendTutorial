...
/**
 * Criteria class for the {@link com.mycompany.myapp.domain.SubDistrict} entity. This class is used
 * in {@link com.mycompany.myapp.web.rest.SubDistrictResource} to receive all the possible filtering options from
 * the Http GET request parameters.
 * For example the following could be a valid request:
 * {@code /sub-districts?id.greaterThan=5&attr1.contains=something&attr2.specified=false}
 * As Spring is unable to properly convert the types, unless specific {@link Filter} class are used, we need to use
 * fix type specific filters.
 */
@ParameterObject
@SuppressWarnings("common-java:DuplicatedBlocks")
public class SubDistrictCriteria implements Serializable, Criteria {
    ...
    public SubDistrictCriteria() {}

    public SubDistrictCriteria(SubDistrictCriteria other) {
    ...
    @Override
    public SubDistrictCriteria copy() {
        return new SubDistrictCriteria(this);
    }
    ...
    public boolean equals(Object o) {
        ...
        final SubDistrictCriteria that = (SubDistrictCriteria) o;
        return (
