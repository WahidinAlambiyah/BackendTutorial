...
describe('Service Tests', () => {
  describe('Service Service', () => {
    ...
    beforeEach(() => {
      ...
      elemDefault = new Service(123, 'AAAAAAA', 'AAAAAAA', 0, 0, 'EVENT_MANAGEMENT');
    });
    ...
    describe('Service methods', () => {
      ...
      it('should partial update a Service', async () => {
      ...
      it('should not partial update a Service', async () => {
      ...
      it('should not return a list of Service', async () => {
        axiosStub.get.rejects(error);
