  ...
  <div class="row justify-content-center">
    <div class="col-8">
      <form name="editForm" novalidate v-on:submit.prevent="save()">
        <h2
          id="jHipsterMonolithApp.location.home.createOrEditLabel"
          data-cy="LocationCreateUpdateHeading"
          v-text="t$('jHipsterMonolithApp.location.home.createOrEditLabel')"
        ></h2>
        <div>
          ...
          <div class="form-group">
            <label
              ...
              v-text="t$('jHipsterMonolithApp.location.streetAddress')"
          ...
          <div class="form-group">
            <label class="form-control-label" v-text="t$('jHipsterMonolithApp.location.postalCode')" for="location-postalCode"></label>
            <input
              type="text"
              class="form-control"
              name="postalCode"
          ...
          <div class="form-group">
            <label class="form-control-label" v-text="t$('jHipsterMonolithApp.location.city')" for="location-city"></label>
            <input
              type="text"
              class="form-control"
              name="city"
          ...
          <div class="form-group">
            <label
              class="form-control-label"
              v-text="t$('jHipsterMonolithApp.location.stateProvince')"
