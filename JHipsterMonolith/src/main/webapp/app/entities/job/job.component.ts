  ...
  setup() {
    ...
    const retrieveJobs = async () => {
      ...
      try {
        ...
        const res = currentSearch.value
          ? await jobService().search(currentSearch.value, paginationQuery)
          : await jobService().retrieve(paginationQuery);
    ...
    const removeJob = async () => {
      try {
        ...
        const message = t$('jHipsterMonolithApp.job.deleted', { param: removeId.value }).toString();
