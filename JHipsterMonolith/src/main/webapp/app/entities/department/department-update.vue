  ...
  <div class="row justify-content-center">
    <div class="col-8">
      <form name="editForm" novalidate v-on:submit.prevent="save()">
        <h2
          id="jHipsterMonolithApp.department.home.createOrEditLabel"
          data-cy="DepartmentCreateUpdateHeading"
          v-text="t$('jHipsterMonolithApp.department.home.createOrEditLabel')"
        ></h2>
        <div>
          ...
          <div class="form-group">
            <label
              ...
              v-text="t$('jHipsterMonolithApp.department.departmentName')"
          ...
          <div class="form-group">
            <label class="form-control-label" v-text="t$('jHipsterMonolithApp.department.location')" for="department-location"></label>
