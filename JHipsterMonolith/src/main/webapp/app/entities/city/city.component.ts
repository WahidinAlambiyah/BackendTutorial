  ...
  setup() {
    ...
    const retrieveCitys = async () => {
      ...
      try {
        ...
        const res = currentSearch.value
          ? await cityService().search(currentSearch.value, paginationQuery)
          : await cityService().retrieve(paginationQuery);
    ...
    const removeCity = async () => {
      try {
        ...
        const message = t$('jHipsterMonolithApp.city.deleted', { param: removeId.value }).toString();
