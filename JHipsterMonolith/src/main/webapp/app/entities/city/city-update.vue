    ...
    <div class="col-8">
      <form name="editForm" novalidate v-on:submit.prevent="save()">
        ...
        <div>
          ...
          <div class="form-group">
            <label class="form-control-label" v-text="t$('jHipsterMonolithApp.city.unm49Code')" for="city-unm49Code"></label>
            <input
              type="text"
              class="form-control"
              name="unm49Code"
          ...
          <div class="form-group">
            <label class="form-control-label" v-text="t$('jHipsterMonolithApp.city.isoAlpha2Code')" for="city-isoAlpha2Code"></label>
            <input
              type="text"
              class="form-control"
              name="isoAlpha2Code"
              id="city-isoAlpha2Code"
