  ...
  setup() {
    ...
    const retrieveEmployees = async () => {
      ...
      try {
        ...
        const res = currentSearch.value
          ? await employeeService().search(currentSearch.value, paginationQuery)
          : await employeeService().retrieve(paginationQuery);
    ...
    const removeEmployee = async () => {
      try {
        ...
        const message = t$('jHipsterMonolithApp.employee.deleted', { param: removeId.value }).toString();
