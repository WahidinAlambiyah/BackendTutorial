...
type StockComponentType = InstanceType<typeof Stock>;
...
describe('Component Tests', () => {
  ...
  describe('Stock Management Component', () => {
    ...
    let mountOptions: MountingOptions<StockComponentType>['global'];
    ...
    describe('Mount', () => {
      it('Should call load all on init', async () => {
        ...
        // WHEN
        const wrapper = shallowMount(Stock, { global: mountOptions });
        const comp = wrapper.vm;
        await comp.$nextTick();

        // THEN
        expect(stockServiceStub.retrieve.calledOnce).toBeTruthy();
      ...
      it('should calculate the sort attribute for an id', async () => {
        ...
        // THEN
        expect(stockServiceStub.retrieve.lastCall.firstArg).toMatchObject({
          sort: ['id,asc'],
        });
      });
    });
    describe('Handles', () => {
      let comp: StockComponentType;

      beforeEach(async () => {
        const wrapper = shallowMount(Stock, { global: mountOptions });
        comp = wrapper.vm;
        await comp.$nextTick();
        stockServiceStub.retrieve.reset();
        stockServiceStub.retrieve.resolves({ headers: {}, data: [] });
      });
      ...
      it('should not load a page if the page is the same as the previous page', () => {
        ...
        // THEN
        expect(stockServiceStub.retrieve.called).toBeFalsy();
      });
