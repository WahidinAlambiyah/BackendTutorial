...
/**
 * Criteria class for the {@link com.mycompany.myapp.domain.MstCountry} entity. This class is used
 * in {@link com.mycompany.myapp.web.rest.MstCountryResource} to receive all the possible filtering options from
 * the Http GET request parameters.
 * For example the following could be a valid request:
 * {@code /mst-countries?id.greaterThan=5&attr1.contains=something&attr2.specified=false}
 * As Spring is unable to properly convert the types, unless specific {@link Filter} class are used, we need to use
 * fix type specific filters.
 */
@ParameterObject
@SuppressWarnings("common-java:DuplicatedBlocks")
public class MstCountryCriteria implements Serializable, Criteria {
    ...
    public MstCountryCriteria() {}

    public MstCountryCriteria(MstCountryCriteria other) {
    ...
    @Override
    public MstCountryCriteria copy() {
        return new MstCountryCriteria(this);
    }
    ...
    public boolean equals(Object o) {
        ...
        final MstCountryCriteria that = (MstCountryCriteria) o;
        return (
