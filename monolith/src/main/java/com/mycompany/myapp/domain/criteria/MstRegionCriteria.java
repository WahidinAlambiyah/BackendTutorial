...
/**
 * Criteria class for the {@link com.mycompany.myapp.domain.MstRegion} entity. This class is used
 * in {@link com.mycompany.myapp.web.rest.MstRegionResource} to receive all the possible filtering options from
 * the Http GET request parameters.
 * For example the following could be a valid request:
 * {@code /mst-regions?id.greaterThan=5&attr1.contains=something&attr2.specified=false}
 * As Spring is unable to properly convert the types, unless specific {@link Filter} class are used, we need to use
 * fix type specific filters.
 */
@ParameterObject
@SuppressWarnings("common-java:DuplicatedBlocks")
public class MstRegionCriteria implements Serializable, Criteria {
    ...
    public MstRegionCriteria() {}

    public MstRegionCriteria(MstRegionCriteria other) {
    ...
    @Override
    public MstRegionCriteria copy() {
        return new MstRegionCriteria(this);
    }
    ...
    public boolean equals(Object o) {
        ...
        final MstRegionCriteria that = (MstRegionCriteria) o;
        return (
    ...
    @Override
    public int hashCode() {
        return Objects.hash(id, name, unm49Code, isoAlpha2Code, distinct);
    }

    // prettier-ignore
    @Override
    public String toString() {
        return "MstRegionCriteria{" +
