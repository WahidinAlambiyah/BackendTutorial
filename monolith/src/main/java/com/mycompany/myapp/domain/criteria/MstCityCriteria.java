...
/**
 * Criteria class for the {@link com.mycompany.myapp.domain.MstCity} entity. This class is used
 * in {@link com.mycompany.myapp.web.rest.MstCityResource} to receive all the possible filtering options from
 * the Http GET request parameters.
 * For example the following could be a valid request:
 * {@code /mst-cities?id.greaterThan=5&attr1.contains=something&attr2.specified=false}
 * As Spring is unable to properly convert the types, unless specific {@link Filter} class are used, we need to use
 * fix type specific filters.
 */
@ParameterObject
@SuppressWarnings("common-java:DuplicatedBlocks")
public class MstCityCriteria implements Serializable, Criteria {
    ...
    public MstCityCriteria() {}

    public MstCityCriteria(MstCityCriteria other) {
    ...
    @Override
    public MstCityCriteria copy() {
        return new MstCityCriteria(this);
    }
    ...
    public boolean equals(Object o) {
        ...
        final MstCityCriteria that = (MstCityCriteria) o;
        return (
    ...
    @Override
    public int hashCode() {
        return Objects.hash(id, name, unm49Code, isoAlpha2Code, provinceId, distinct);
    }

    // prettier-ignore
    @Override
    public String toString() {
        return "MstCityCriteria{" +
