...
/**
 * Criteria class for the {@link com.mycompany.myapp.domain.MstCustomer} entity. This class is used
 * in {@link com.mycompany.myapp.web.rest.MstCustomerResource} to receive all the possible filtering options from
 * the Http GET request parameters.
 * For example the following could be a valid request:
 * {@code /mst-customers?id.greaterThan=5&attr1.contains=something&attr2.specified=false}
 * As Spring is unable to properly convert the types, unless specific {@link Filter} class are used, we need to use
 * fix type specific filters.
 */
@ParameterObject
@SuppressWarnings("common-java:DuplicatedBlocks")
public class MstCustomerCriteria implements Serializable, Criteria {
    ...
    public MstCustomerCriteria() {}

    public MstCustomerCriteria(MstCustomerCriteria other) {
    ...
    @Override
    public MstCustomerCriteria copy() {
        return new MstCustomerCriteria(this);
    }
    ...
    public boolean equals(Object o) {
        ...
        final MstCustomerCriteria that = (MstCustomerCriteria) o;
        return (
    ...
    @Override
    public int hashCode() {
        return Objects.hash(id, firstName, lastName, email, phoneNumber, address, loyaltyPoints, distinct);
    }

    // prettier-ignore
    @Override
    public String toString() {
        return "MstCustomerCriteria{" +
