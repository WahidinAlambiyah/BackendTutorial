...
/**
 * Criteria class for the {@link com.mycompany.myapp.domain.MstEmployee} entity. This class is used
 * in {@link com.mycompany.myapp.web.rest.MstEmployeeResource} to receive all the possible filtering options from
 * the Http GET request parameters.
 * For example the following could be a valid request:
 * {@code /mst-employees?id.greaterThan=5&attr1.contains=something&attr2.specified=false}
 * As Spring is unable to properly convert the types, unless specific {@link Filter} class are used, we need to use
 * fix type specific filters.
 */
@ParameterObject
@SuppressWarnings("common-java:DuplicatedBlocks")
public class MstEmployeeCriteria implements Serializable, Criteria {
    ...
    public MstEmployeeCriteria(MstEmployeeCriteria other) {
    ...
    @Override
    public MstEmployeeCriteria copy() {
        return new MstEmployeeCriteria(this);
    }
    ...
    public boolean equals(Object o) {
        ...
        final MstEmployeeCriteria that = (MstEmployeeCriteria) o;
        return (
