...
/**
 * A DTO for the {@link com.mycompany.myapp.domain.MstRegion} entity.
 */
@SuppressWarnings("common-java:DuplicatedBlocks")
public class MstRegionDTO implements Serializable {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof MstRegionDTO)) {
            return false;
        }

        MstRegionDTO mstRegionDTO = (MstRegionDTO) o;
        if (this.id == null) {
            return false;
        }
        return Objects.equals(this.id, mstRegionDTO.id);
    }
