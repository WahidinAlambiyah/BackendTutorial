...
@RestController
@RequestMapping("/api/monolith-kafka")
public class MonolithKafkaResource {

    private static final String PRODUCER_BINDING_NAME = "binding-out-0";

    private static final Logger log = LoggerFactory.getLogger(MonolithKafkaResource.class);
    private final KafkaConsumer kafkaConsumer;
    private final StreamBridge streamBridge;

    public MonolithKafkaResource(StreamBridge streamBridge, KafkaConsumer kafkaConsumer) {
