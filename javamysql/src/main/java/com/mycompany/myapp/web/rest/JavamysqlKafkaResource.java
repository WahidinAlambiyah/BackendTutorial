...
@RestController
@RequestMapping("/api/javamysql-kafka")
public class JavamysqlKafkaResource {

    private static final String PRODUCER_BINDING_NAME = "binding-out-0";

    private static final Logger log = LoggerFactory.getLogger(JavamysqlKafkaResource.class);
    private final KafkaConsumer kafkaConsumer;
    private final StreamBridge streamBridge;

    public JavamysqlKafkaResource(StreamBridge streamBridge, KafkaConsumer kafkaConsumer) {
